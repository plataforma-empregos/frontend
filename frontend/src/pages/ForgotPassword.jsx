	...
	return (
		   <div className="min-h-screen flex items-center justify-center bg-gray-100">
			   <div className="bg-white p-8 rounded-2xl shadow-lg w-96">
				...
				<p className="text-gray-600 text-center mb-6">Enter your email address to get the password reset link.</p>
				<form onSubmit={handleSubmit} className="space-y-4">
					<div>
						   <label htmlFor="email" className="block text-gray-700 font-semibold mb-1 text-left">Email Address</label>
						<input
							id="email"
							type="email"
							value={email}
...
// ...existing code from forgotUser App.jsx...
