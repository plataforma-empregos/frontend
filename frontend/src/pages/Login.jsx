	...
	return (
		   <div className="min-h-screen flex items-center justify-center bg-gray-100">
			   <div className="bg-white p-8 rounded-2xl shadow-lg w-96">
				   <h1 className="text-4xl font-bold text-center text-sky-700 mb-4">TrampoMATCH</h1>
				<form onSubmit={handleSubmit} className="space-y-4">
					...
					<div>
						...
						<div className="relative">
							...
							>
								{showPassword ? (
									<svg xmlns="http://www.w3.org/2000/svg" fill="#0069A8" viewBox="0 0 24 24" width="22" height="22"><path d="M12 4.5C7.305 4.5 3.135 7.364 1.5 12c1.635 4.636 5.805 7.5 10.5 7.5s8.865-2.864 10.5-7.5C20.865 7.364 16.695 4.5 12 4.5zm0 13c-3.59 0-6.79-2.13-8.19-5.5C5.21 8.13 8.41 6 12 6s6.79 2.13 8.19 5.5c-1.4 3.37-4.6 5.5-8.19 5.5zm0-9A3.5 3.5 0 1 0 12 16a3.5 3.5 0 0 0 0-7zm0 5A1.5 1.5 0 1 1 12 9a1.5 1.5 0 0 1 0 3z"/></svg>
								) : (
									<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#0069A8" strokeWidth="2" viewBox="0 0 24 24" width="22" height="22"><path d="M1.5 12C3.135 7.364 7.305 4.5 12 4.5s8.865 2.864 10.5 7.5c-1.635 4.636-5.805 7.5-10.5 7.5S3.135 16.636 1.5 12z"/><circle cx="12" cy="12" r="3.5"/></svg>
								)}
							</button>
						</div>
					</div>
...
// ...existing code from loginUser App.jsx...
