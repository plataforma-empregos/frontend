            ...
            {formacaoFields.map((field, index) => (
              <div key={field.id} className="flex items-center gap-4 mb-2">
                <input
                  ...
                  className="border p-3 rounded-lg flex-grow focus:ring-2 focus:ring-blue-500 focus:outline-none"
                ...
                {formacaoFields.length > 1 && (
                  <button
                    ...
                    className="bg-red-600 text-white hover:bg-red-700 transition font-semibold text-sm"
                  >
                    Remover
                  </button>
                )}
